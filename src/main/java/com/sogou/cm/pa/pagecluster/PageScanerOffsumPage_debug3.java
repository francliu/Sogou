...
public class PageScanerOffsumPage_debug3 {
			...
			for(ContentItem ci : opw.contentItems){
				...
				if (ci.content.length > 0) {
					int rc = 0;
						...
						try {
							parser.parse(new InputSource(new StringReader(htmlPage.substring(i))));
							System.out.println(opw.url + "\t" + htmlContentHandler.main_content_out);
