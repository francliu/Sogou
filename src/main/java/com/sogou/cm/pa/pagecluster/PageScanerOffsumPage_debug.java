...
public class PageScanerOffsumPage_debug {
	public static void main(String[] args) throws IOException, InterruptedException {
		OffsumPageInputFormatV2 inputFormat = new OffsumPageInputFormatV2();
		RecordReader reader = inputFormat.createRecordReader(null, null);
	//	FileSystem fs = FileSystem.getLocal(new Configuration());
		File file = new File("C:\\Users\\sunjian\\Downloads\\part-r-00000");
		FileSplit file_split = new FileSplit(new Path("C:\\Users\\sunjian\\Downloads\\part-r-00000"), 0, file.length(), null);
		reader.initialize(file_split, new TaskAttemptContextImpl(new Configuration(), new TaskAttemptID()));

		String test_url = "http://kaoshi.china.com/daoyou/peixun/2767167.htm";
