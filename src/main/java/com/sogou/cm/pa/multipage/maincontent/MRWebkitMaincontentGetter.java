...
public class MRWebkitMaincontentGetter extends Configured implements Tool {
...
decompresser.setInput(value.body.getBytes(),0, value.body.getLength());
					...
					//System.out.println(value.url + "\tbegin");
					List<Element> blocks = main_content.extractAllBlock(value.url.toString(), htmlPage);
				//	System.out.println(value.url + "\tend");
	...
	public static void main(String[] args) throws Exception {
		Tool pageScanner = new MRWebkitMaincontentGetter();
